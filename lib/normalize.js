...
const IK = (() => {
  ...
  function registerScraper(def) {
    // Kontextový pruh s návodem (lib/banner.js + lib/guides.js) — volitelný,
    // jeho chyba nesmí shodit scraper.
    try {
      if (typeof IK_BANNER !== "undefined") IK_BANNER.attach(def);
    } catch { /* banner je jen nápověda */ }
