...
const IK = (() => {
  ...
  // rule, keyed broker -> ALREADY-NORMALIZED input ticker -> native position
  // currency -> final Yahoo ticker. The currency key is a guard: the same
  ...
  // own venue/symbol mapping — never duplicate these inside a scraper. If the
